...
define void @test_x86_sse_max_ps(ptr %p1, ptr %p2) {
  ...
  ; CHECK-NEXT:   [[LOAD2:%[0-9]+]]:vecr(<4 x f32>) = G_LOAD [[LOAD]](p0) :: (load (<4 x f32>) from %ir.p1)
  ; CHECK-NEXT:   [[LOAD3:%[0-9]+]]:vecr(<4 x f32>) = G_LOAD [[LOAD1]](p0) :: (load (<4 x f32>) from %ir.p2)
  ; CHECK-NEXT:   [[INT:%[0-9]+]]:vecr(<4 x f32>) = G_INTRINSIC intrinsic(@llvm.x86.sse.max.ps), [[LOAD2]](<4 x f32>), [[LOAD3]](<4 x f32>)
  ; CHECK-NEXT:   G_STORE [[INT]](<4 x f32>), [[LOAD]](p0) :: (store (<4 x f32>) into %ir.p1)
  ; CHECK-NEXT:   RET 0
...
define void @test_x86_sse_max_ss(ptr %p1, ptr %p2) {
  ...
  ; CHECK-NEXT:   [[LOAD2:%[0-9]+]]:vecr(<4 x f32>) = G_LOAD [[LOAD]](p0) :: (load (<4 x f32>) from %ir.p1)
  ; CHECK-NEXT:   [[LOAD3:%[0-9]+]]:vecr(<4 x f32>) = G_LOAD [[LOAD1]](p0) :: (load (<4 x f32>) from %ir.p2)
  ; CHECK-NEXT:   [[INT:%[0-9]+]]:vecr(<4 x f32>) = G_INTRINSIC intrinsic(@llvm.x86.sse.max.ss), [[LOAD2]](<4 x f32>), [[LOAD3]](<4 x f32>)
  ; CHECK-NEXT:   G_STORE [[INT]](<4 x f32>), [[LOAD]](p0) :: (store (<4 x f32>) into %ir.p1)
  ; CHECK-NEXT:   RET 0
  %a0 = load <4 x float>, ptr %p1, align 16
  %a1 = load <4 x float>, ptr %p2, align 16
...
define void @test_x86_sse_min_ps(ptr %p1, ptr %p2) {
  ...
  ; CHECK-NEXT:   [[LOAD2:%[0-9]+]]:vecr(<4 x f32>) = G_LOAD [[LOAD]](p0) :: (load (<4 x f32>) from %ir.p1)
  ; CHECK-NEXT:   [[LOAD3:%[0-9]+]]:vecr(<4 x f32>) = G_LOAD [[LOAD1]](p0) :: (load (<4 x f32>) from %ir.p2)
  ; CHECK-NEXT:   [[INT:%[0-9]+]]:vecr(<4 x f32>) = G_INTRINSIC intrinsic(@llvm.x86.sse.min.ps), [[LOAD2]](<4 x f32>), [[LOAD3]](<4 x f32>)
  ; CHECK-NEXT:   G_STORE [[INT]](<4 x f32>), [[LOAD]](p0) :: (store (<4 x f32>) into %ir.p1)
  ; CHECK-NEXT:   RET 0
  %a0 = load <4 x float>, ptr %p1, align 16
  %a1 = load <4 x float>, ptr %p2, align 16
...
define void @test_x86_sse_min_ss(ptr %p1, ptr %p2) {
  ...
  ; CHECK-NEXT:   [[LOAD2:%[0-9]+]]:vecr(<4 x f32>) = G_LOAD [[LOAD]](p0) :: (load (<4 x f32>) from %ir.p1)
  ; CHECK-NEXT:   [[LOAD3:%[0-9]+]]:vecr(<4 x f32>) = G_LOAD [[LOAD1]](p0) :: (load (<4 x f32>) from %ir.p2)
  ; CHECK-NEXT:   [[INT:%[0-9]+]]:vecr(<4 x f32>) = G_INTRINSIC intrinsic(@llvm.x86.sse.min.ss), [[LOAD2]](<4 x f32>), [[LOAD3]](<4 x f32>)
  ; CHECK-NEXT:   G_STORE [[INT]](<4 x f32>), [[LOAD]](p0) :: (store (<4 x f32>) into %ir.p1)
  ; CHECK-NEXT:   RET 0
  %a0 = load <4 x float>, ptr %p1, align 16
  %a1 = load <4 x float>, ptr %p2, align 16
...
define void @test_x86_sse_rcp_ps(ptr %p1, ptr %p2) {
  ...
  ; CHECK-NEXT:   [[FRAME_INDEX:%[0-9]+]]:gpr(p0) = G_FRAME_INDEX %fixed-stack.1
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:gpr(p0) = G_LOAD [[FRAME_INDEX]](p0) :: (invariant load (p0) from %fixed-stack.1)
  ; CHECK-NEXT:   [[LOAD1:%[0-9]+]]:vecr(<4 x f32>) = G_LOAD [[LOAD]](p0) :: (load (<4 x f32>) from %ir.p1)
  ; CHECK-NEXT:   [[INT:%[0-9]+]]:vecr(<4 x f32>) = G_INTRINSIC intrinsic(@llvm.x86.sse.rcp.ps), [[LOAD1]](<4 x f32>)
  ; CHECK-NEXT:   G_STORE [[INT]](<4 x f32>), [[LOAD]](p0) :: (store (<4 x f32>) into %ir.p1)
  ; CHECK-NEXT:   RET 0
  %a0 = load <4 x float>, ptr %p1, align 16
...
define void @test_x86_sse_rcp_ss(ptr %p1, ptr %p2) {
  ...
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:gpr(p0) = G_LOAD [[FRAME_INDEX]](p0) :: (invariant load (p0) from %fixed-stack.1)
  ; CHECK-NEXT:   [[LOAD1:%[0-9]+]]:vecr(<4 x f32>) = G_LOAD [[LOAD]](p0) :: (load (<4 x f32>) from %ir.p1)
  ; CHECK-NEXT:   [[INT:%[0-9]+]]:vecr(<4 x f32>) = G_INTRINSIC intrinsic(@llvm.x86.sse.rcp.ss), [[LOAD1]](<4 x f32>)
  ; CHECK-NEXT:   G_STORE [[INT]](<4 x f32>), [[LOAD]](p0) :: (store (<4 x f32>) into %ir.p1)
  ; CHECK-NEXT:   RET 0
  %a0 = load <4 x float>, ptr %p1, align 16
...
define void @test_x86_sse_rsqrt_ps(ptr %p1, ptr %p2) {
  ...
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:gpr(p0) = G_LOAD [[FRAME_INDEX]](p0) :: (invariant load (p0) from %fixed-stack.1)
  ; CHECK-NEXT:   [[LOAD1:%[0-9]+]]:vecr(<4 x f32>) = G_LOAD [[LOAD]](p0) :: (load (<4 x f32>) from %ir.p1)
  ; CHECK-NEXT:   [[INT:%[0-9]+]]:vecr(<4 x f32>) = G_INTRINSIC intrinsic(@llvm.x86.sse.rsqrt.ps), [[LOAD1]](<4 x f32>)
  ; CHECK-NEXT:   G_STORE [[INT]](<4 x f32>), [[LOAD]](p0) :: (store (<4 x f32>) into %ir.p1)
  ; CHECK-NEXT:   RET 0
  %a0 = load <4 x float>, ptr %p1, align 16
...
define void @test_x86_sse_rsqrt_ss(ptr %p1, ptr %p2) {
  ...
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:gpr(p0) = G_LOAD [[FRAME_INDEX]](p0) :: (invariant load (p0) from %fixed-stack.1)
  ; CHECK-NEXT:   [[LOAD1:%[0-9]+]]:vecr(<4 x f32>) = G_LOAD [[LOAD]](p0) :: (load (<4 x f32>) from %ir.p1)
  ; CHECK-NEXT:   [[INT:%[0-9]+]]:vecr(<4 x f32>) = G_INTRINSIC intrinsic(@llvm.x86.sse.rsqrt.ss), [[LOAD1]](<4 x f32>)
  ; CHECK-NEXT:   G_STORE [[INT]](<4 x f32>), [[LOAD]](p0) :: (store (<4 x f32>) into %ir.p1)
  ; CHECK-NEXT:   RET 0
  %a0 = load <4 x float>, ptr %p1, align 16
