...
define ptr @ret_ptr() {
  ...
  ; X32ABI:   [[ZEXT:%[0-9]+]]:_(i64) = G_ZEXT [[PTRTOINT]](s32)
  ; X32ABI:   $rax = COPY [[ZEXT]](i64)
...
define void @arg_ptr(ptr %ptr) {
  ...
  ; X32ABI: bb.1 (%ir-block.0):
  ; X32ABI:   liveins: $rdi
  ; X32ABI:   [[COPY:%[0-9]+]]:_(i64) = COPY $rdi
  ; X32ABI:   [[TRUNC:%[0-9]+]]:_(s32) = G_TRUNC [[COPY]](i64)
  ; X32ABI:   [[INTTOPTR:%[0-9]+]]:_(p0) = G_INTTOPTR [[TRUNC]](s32)
  ; X32ABI:   [[C:%[0-9]+]]:_(i32) = G_CONSTANT i32 1
  ; X32ABI:   G_STORE [[C]](i32), [[INTTOPTR]](p0) :: (store (i32) into %ir.ptr)
  ; X32ABI:   RET 0
  store i32 1, ptr %ptr
  ret void
}
