...
define i8 @test_i8_args_8(i8 %arg1, i8 %arg2, i8 %arg3, i8 %arg4, i8 %arg5, i8 %arg6, i8 %arg7, i8 %arg8) {
  ...
  ; X86-NEXT:   [[LOAD:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX]](p0) :: (invariant load (i8) from %fixed-stack.7, align 16)
  ; X86-NEXT:   [[TRUNC:%[0-9]+]]:_(i8) = G_TRUNC [[LOAD]](i32)
  ; X86-NEXT:   [[FRAME_INDEX1:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.6
  ; X86-NEXT:   [[LOAD1:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX1]](p0) :: (invariant load (i8) from %fixed-stack.6, align 4)
  ; X86-NEXT:   [[TRUNC1:%[0-9]+]]:_(i8) = G_TRUNC [[LOAD1]](i32)
  ; X86-NEXT:   [[FRAME_INDEX2:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.5
  ; X86-NEXT:   [[LOAD2:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX2]](p0) :: (invariant load (i8) from %fixed-stack.5, align 8)
  ; X86-NEXT:   [[TRUNC2:%[0-9]+]]:_(i8) = G_TRUNC [[LOAD2]](i32)
  ; X86-NEXT:   [[FRAME_INDEX3:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.4
  ; X86-NEXT:   [[LOAD3:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX3]](p0) :: (invariant load (i8) from %fixed-stack.4, align 4)
  ; X86-NEXT:   [[TRUNC3:%[0-9]+]]:_(i8) = G_TRUNC [[LOAD3]](i32)
  ; X86-NEXT:   [[FRAME_INDEX4:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.3
  ; X86-NEXT:   [[LOAD4:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX4]](p0) :: (invariant load (i8) from %fixed-stack.3, align 16)
  ; X86-NEXT:   [[TRUNC4:%[0-9]+]]:_(i8) = G_TRUNC [[LOAD4]](i32)
  ; X86-NEXT:   [[FRAME_INDEX5:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.2
  ; X86-NEXT:   [[LOAD5:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX5]](p0) :: (invariant load (i8) from %fixed-stack.2, align 4)
  ; X86-NEXT:   [[TRUNC5:%[0-9]+]]:_(i8) = G_TRUNC [[LOAD5]](i32)
  ; X86-NEXT:   [[FRAME_INDEX6:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.1
  ; X86-NEXT:   [[LOAD6:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX6]](p0) :: (invariant load (i8) from %fixed-stack.1, align 8)
  ; X86-NEXT:   [[TRUNC6:%[0-9]+]]:_(i8) = G_TRUNC [[LOAD6]](i32)
  ; X86-NEXT:   [[FRAME_INDEX7:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.0
  ; X86-NEXT:   [[LOAD7:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX7]](p0) :: (invariant load (i8) from %fixed-stack.0, align 4)
  ; X86-NEXT:   [[TRUNC7:%[0-9]+]]:_(i8) = G_TRUNC [[LOAD7]](i32)
  ...
  ; X86-NEXT:   G_STORE [[TRUNC]](i8), [[GV]](p0) :: (store (i8) into @a1_8bit)
  ; X86-NEXT:   G_STORE [[TRUNC6]](i8), [[GV1]](p0) :: (store (i8) into @a7_8bit)
  ; X86-NEXT:   G_STORE [[TRUNC7]](i8), [[GV2]](p0) :: (store (i8) into @a8_8bit)
  ; X86-NEXT:   $al = COPY [[TRUNC]](i8)
  ...
  ; X64-NEXT: {{  $}}
  ; X64-NEXT:   [[COPY:%[0-9]+]]:_(i32) = COPY $edi
  ; X64-NEXT:   [[TRUNC:%[0-9]+]]:_(i8) = G_TRUNC [[COPY]](i32)
  ; X64-NEXT:   [[COPY1:%[0-9]+]]:_(i32) = COPY $esi
  ; X64-NEXT:   [[TRUNC1:%[0-9]+]]:_(i8) = G_TRUNC [[COPY1]](i32)
  ; X64-NEXT:   [[COPY2:%[0-9]+]]:_(i32) = COPY $edx
  ; X64-NEXT:   [[TRUNC2:%[0-9]+]]:_(i8) = G_TRUNC [[COPY2]](i32)
  ; X64-NEXT:   [[COPY3:%[0-9]+]]:_(i32) = COPY $ecx
  ; X64-NEXT:   [[TRUNC3:%[0-9]+]]:_(i8) = G_TRUNC [[COPY3]](i32)
  ; X64-NEXT:   [[COPY4:%[0-9]+]]:_(i32) = COPY $r8d
  ; X64-NEXT:   [[TRUNC4:%[0-9]+]]:_(i8) = G_TRUNC [[COPY4]](i32)
  ; X64-NEXT:   [[COPY5:%[0-9]+]]:_(i32) = COPY $r9d
  ; X64-NEXT:   [[TRUNC5:%[0-9]+]]:_(i8) = G_TRUNC [[COPY5]](i32)
  ; X64-NEXT:   [[FRAME_INDEX:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.1
  ; X64-NEXT:   [[LOAD:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX]](p0) :: (invariant load (i8) from %fixed-stack.1, align 16)
  ; X64-NEXT:   [[TRUNC6:%[0-9]+]]:_(i8) = G_TRUNC [[LOAD]](i32)
  ; X64-NEXT:   [[FRAME_INDEX1:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.0
  ; X64-NEXT:   [[LOAD1:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX1]](p0) :: (invariant load (i8) from %fixed-stack.0, align 8)
  ; X64-NEXT:   [[TRUNC7:%[0-9]+]]:_(i8) = G_TRUNC [[LOAD1]](i32)
  ...
  ; X64-NEXT:   G_STORE [[TRUNC]](i8), [[GV]](p0) :: (store (i8) into @a1_8bit)
  ; X64-NEXT:   G_STORE [[TRUNC6]](i8), [[GV1]](p0) :: (store (i8) into @a7_8bit)
  ; X64-NEXT:   G_STORE [[TRUNC7]](i8), [[GV2]](p0) :: (store (i8) into @a8_8bit)
  ; X64-NEXT:   $al = COPY [[TRUNC]](i8)
...
define i32 @test_i32_args_8(i32 %arg1, i32 %arg2, i32 %arg3, i32 %arg4, i32 %arg5, i32 %arg6, i32 %arg7, i32 %arg8) {
  ...
  ; X86: bb.1.entry:
  ; X86-NEXT:   [[FRAME_INDEX:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.7
  ; X86-NEXT:   [[LOAD:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX]](p0) :: (invariant load (i32) from %fixed-stack.7, align 16)
  ; X86-NEXT:   [[FRAME_INDEX1:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.6
  ; X86-NEXT:   [[LOAD1:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX1]](p0) :: (invariant load (i32) from %fixed-stack.6)
  ; X86-NEXT:   [[FRAME_INDEX2:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.5
  ; X86-NEXT:   [[LOAD2:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX2]](p0) :: (invariant load (i32) from %fixed-stack.5, align 8)
  ; X86-NEXT:   [[FRAME_INDEX3:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.4
  ; X86-NEXT:   [[LOAD3:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX3]](p0) :: (invariant load (i32) from %fixed-stack.4)
  ; X86-NEXT:   [[FRAME_INDEX4:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.3
  ; X86-NEXT:   [[LOAD4:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX4]](p0) :: (invariant load (i32) from %fixed-stack.3, align 16)
  ; X86-NEXT:   [[FRAME_INDEX5:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.2
  ; X86-NEXT:   [[LOAD5:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX5]](p0) :: (invariant load (i32) from %fixed-stack.2)
  ; X86-NEXT:   [[FRAME_INDEX6:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.1
  ; X86-NEXT:   [[LOAD6:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX6]](p0) :: (invariant load (i32) from %fixed-stack.1, align 8)
  ; X86-NEXT:   [[FRAME_INDEX7:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.0
  ; X86-NEXT:   [[LOAD7:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX7]](p0) :: (invariant load (i32) from %fixed-stack.0)
  ...
  ; X86-NEXT:   G_STORE [[LOAD]](i32), [[GV]](p0) :: (store (i32) into @a1_32bit)
  ; X86-NEXT:   G_STORE [[LOAD6]](i32), [[GV1]](p0) :: (store (i32) into @a7_32bit)
  ; X86-NEXT:   G_STORE [[LOAD7]](i32), [[GV2]](p0) :: (store (i32) into @a8_32bit)
  ; X86-NEXT:   $eax = COPY [[LOAD]](i32)
  ...
  ; X64-NEXT:   [[COPY5:%[0-9]+]]:_(i32) = COPY $r9d
  ; X64-NEXT:   [[FRAME_INDEX:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.1
  ; X64-NEXT:   [[LOAD:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX]](p0) :: (invariant load (i32) from %fixed-stack.1, align 16)
  ; X64-NEXT:   [[FRAME_INDEX1:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.0
  ; X64-NEXT:   [[LOAD1:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX1]](p0) :: (invariant load (i32) from %fixed-stack.0, align 8)
  ...
  ; X64-NEXT:   G_STORE [[COPY]](i32), [[GV]](p0) :: (store (i32) into @a1_32bit)
  ; X64-NEXT:   G_STORE [[LOAD]](i32), [[GV1]](p0) :: (store (i32) into @a7_32bit)
  ; X64-NEXT:   G_STORE [[LOAD1]](i32), [[GV2]](p0) :: (store (i32) into @a8_32bit)
  ; X64-NEXT:   $eax = COPY [[COPY]](i32)
...
define i64 @test_i64_args_8(i64 %arg1, i64 %arg2, i64 %arg3, i64 %arg4, i64 %arg5, i64 %arg6, i64 %arg7, i64 %arg8) {
  ...
  ; X86-NEXT:   [[LOAD:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX]](p0) :: (invariant load (i32) from %fixed-stack.15, align 16)
  ; X86-NEXT:   [[FRAME_INDEX1:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.14
  ; X86-NEXT:   [[LOAD1:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX1]](p0) :: (invariant load (i32) from %fixed-stack.14)
  ; X86-NEXT:   [[MV:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[LOAD]](i32), [[LOAD1]](i32)
  ; X86-NEXT:   [[FRAME_INDEX2:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.13
  ; X86-NEXT:   [[LOAD2:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX2]](p0) :: (invariant load (i32) from %fixed-stack.13, align 8)
  ; X86-NEXT:   [[FRAME_INDEX3:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.12
  ; X86-NEXT:   [[LOAD3:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX3]](p0) :: (invariant load (i32) from %fixed-stack.12)
  ; X86-NEXT:   [[MV1:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[LOAD2]](i32), [[LOAD3]](i32)
  ; X86-NEXT:   [[FRAME_INDEX4:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.11
  ; X86-NEXT:   [[LOAD4:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX4]](p0) :: (invariant load (i32) from %fixed-stack.11, align 16)
  ; X86-NEXT:   [[FRAME_INDEX5:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.10
  ; X86-NEXT:   [[LOAD5:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX5]](p0) :: (invariant load (i32) from %fixed-stack.10)
  ; X86-NEXT:   [[MV2:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[LOAD4]](i32), [[LOAD5]](i32)
  ; X86-NEXT:   [[FRAME_INDEX6:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.9
  ; X86-NEXT:   [[LOAD6:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX6]](p0) :: (invariant load (i32) from %fixed-stack.9, align 8)
  ; X86-NEXT:   [[FRAME_INDEX7:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.8
  ; X86-NEXT:   [[LOAD7:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX7]](p0) :: (invariant load (i32) from %fixed-stack.8)
  ; X86-NEXT:   [[MV3:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[LOAD6]](i32), [[LOAD7]](i32)
  ; X86-NEXT:   [[FRAME_INDEX8:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.7
  ; X86-NEXT:   [[LOAD8:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX8]](p0) :: (invariant load (i32) from %fixed-stack.7, align 16)
  ; X86-NEXT:   [[FRAME_INDEX9:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.6
  ; X86-NEXT:   [[LOAD9:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX9]](p0) :: (invariant load (i32) from %fixed-stack.6)
  ; X86-NEXT:   [[MV4:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[LOAD8]](i32), [[LOAD9]](i32)
  ; X86-NEXT:   [[FRAME_INDEX10:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.5
  ; X86-NEXT:   [[LOAD10:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX10]](p0) :: (invariant load (i32) from %fixed-stack.5, align 8)
  ; X86-NEXT:   [[FRAME_INDEX11:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.4
  ; X86-NEXT:   [[LOAD11:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX11]](p0) :: (invariant load (i32) from %fixed-stack.4)
  ; X86-NEXT:   [[MV5:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[LOAD10]](i32), [[LOAD11]](i32)
  ; X86-NEXT:   [[FRAME_INDEX12:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.3
  ; X86-NEXT:   [[LOAD12:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX12]](p0) :: (invariant load (i32) from %fixed-stack.3, align 16)
  ; X86-NEXT:   [[FRAME_INDEX13:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.2
  ; X86-NEXT:   [[LOAD13:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX13]](p0) :: (invariant load (i32) from %fixed-stack.2)
  ; X86-NEXT:   [[MV6:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[LOAD12]](i32), [[LOAD13]](i32)
  ; X86-NEXT:   [[FRAME_INDEX14:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.1
  ; X86-NEXT:   [[LOAD14:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX14]](p0) :: (invariant load (i32) from %fixed-stack.1, align 8)
  ; X86-NEXT:   [[FRAME_INDEX15:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.0
  ; X86-NEXT:   [[LOAD15:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX15]](p0) :: (invariant load (i32) from %fixed-stack.0)
  ; X86-NEXT:   [[MV7:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[LOAD14]](i32), [[LOAD15]](i32)
  ...
  ; X86-NEXT:   G_STORE [[MV]](i64), [[GV]](p0) :: (store (i64) into @a1_64bit, align 4)
  ; X86-NEXT:   G_STORE [[MV6]](i64), [[GV1]](p0) :: (store (i64) into @a7_64bit, align 4)
  ; X86-NEXT:   G_STORE [[MV7]](i64), [[GV2]](p0) :: (store (i64) into @a8_64bit, align 4)
  ; X86-NEXT:   [[UV:%[0-9]+]]:_(i32), [[UV1:%[0-9]+]]:_(i32) = G_UNMERGE_VALUES [[MV]](i64)
  ; X86-NEXT:   $eax = COPY [[UV]](i32)
  ; X86-NEXT:   $edx = COPY [[UV1]](i32)
  ...
  ; X64-NEXT: {{  $}}
  ; X64-NEXT:   [[COPY:%[0-9]+]]:_(i64) = COPY $rdi
  ; X64-NEXT:   [[COPY1:%[0-9]+]]:_(i64) = COPY $rsi
  ; X64-NEXT:   [[COPY2:%[0-9]+]]:_(i64) = COPY $rdx
  ; X64-NEXT:   [[COPY3:%[0-9]+]]:_(i64) = COPY $rcx
  ; X64-NEXT:   [[COPY4:%[0-9]+]]:_(i64) = COPY $r8
  ; X64-NEXT:   [[COPY5:%[0-9]+]]:_(i64) = COPY $r9
  ; X64-NEXT:   [[FRAME_INDEX:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.1
  ; X64-NEXT:   [[LOAD:%[0-9]+]]:_(i64) = G_LOAD [[FRAME_INDEX]](p0) :: (invariant load (i64) from %fixed-stack.1, align 16)
  ; X64-NEXT:   [[FRAME_INDEX1:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.0
  ; X64-NEXT:   [[LOAD1:%[0-9]+]]:_(i64) = G_LOAD [[FRAME_INDEX1]](p0) :: (invariant load (i64) from %fixed-stack.0)
  ...
  ; X64-NEXT:   G_STORE [[COPY]](i64), [[GV]](p0) :: (store (i64) into @a1_64bit)
  ; X64-NEXT:   G_STORE [[LOAD]](i64), [[GV1]](p0) :: (store (i64) into @a7_64bit)
  ; X64-NEXT:   G_STORE [[LOAD1]](i64), [[GV2]](p0) :: (store (i64) into @a8_64bit)
  ; X64-NEXT:   $rax = COPY [[COPY]](i64)
...
define float @test_float_args(float %arg1, float %arg2) {
  ...
  ; X86-NEXT:   [[LOAD:%[0-9]+]]:_(f32) = G_LOAD [[FRAME_INDEX]](p0) :: (invariant load (f32) from %fixed-stack.1, align 16)
  ; X86-NEXT:   [[FRAME_INDEX1:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.0
  ; X86-NEXT:   [[LOAD1:%[0-9]+]]:_(f32) = G_LOAD [[FRAME_INDEX1]](p0) :: (invariant load (f32) from %fixed-stack.0)
  ; X86-NEXT:   [[FPEXT:%[0-9]+]]:_(s80) = G_FPEXT [[LOAD1]](f32)
  ...
  ; X64-NEXT: {{  $}}
  ; X64-NEXT:   [[COPY:%[0-9]+]]:_(f32) = COPY $xmm0
  ; X64-NEXT:   [[COPY1:%[0-9]+]]:_(f32) = COPY $xmm1
  ; X64-NEXT:   $xmm0 = COPY [[COPY1]](f32)
...
define double @test_double_args(double %arg1, double %arg2) {
  ...
  ; X86: bb.1 (%ir-block.0):
  ; X86-NEXT:   [[FRAME_INDEX:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.1
  ; X86-NEXT:   [[LOAD:%[0-9]+]]:_(f64) = G_LOAD [[FRAME_INDEX]](p0) :: (invariant load (f64) from %fixed-stack.1, align 16)
  ; X86-NEXT:   [[FRAME_INDEX1:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.0
  ; X86-NEXT:   [[LOAD1:%[0-9]+]]:_(f64) = G_LOAD [[FRAME_INDEX1]](p0) :: (invariant load (f64) from %fixed-stack.0)
  ; X86-NEXT:   [[FPEXT:%[0-9]+]]:_(s80) = G_FPEXT [[LOAD1]](f64)
  ; X86-NEXT:   $fp0 = COPY [[FPEXT]](s80)
  ; X86-NEXT:   RET 0, implicit $fp0
  ;
  ...
  ; X64-NEXT:   liveins: $xmm0, $xmm1
  ; X64-NEXT: {{  $}}
  ; X64-NEXT:   [[COPY:%[0-9]+]]:_(f64) = COPY $xmm0
  ; X64-NEXT:   [[COPY1:%[0-9]+]]:_(f64) = COPY $xmm1
  ; X64-NEXT:   $xmm0 = COPY [[COPY1]](f64)
  ; X64-NEXT:   RET 0, implicit $xmm0
  ret double %arg2
}
...
define <4 x i32> @test_v4i32_args(<4 x i32> %arg1, <4 x i32> %arg2) {
  ...
  ; X86-NEXT: {{  $}}
  ; X86-NEXT:   [[COPY:%[0-9]+]]:_(<4 x i32>) = COPY $xmm0
  ; X86-NEXT:   [[COPY1:%[0-9]+]]:_(<4 x i32>) = COPY $xmm1
  ; X86-NEXT:   $xmm0 = COPY [[COPY1]](<4 x i32>)
  ...
  ; X64-NEXT:   liveins: $xmm0, $xmm1
  ; X64-NEXT: {{  $}}
  ; X64-NEXT:   [[COPY:%[0-9]+]]:_(<4 x i32>) = COPY $xmm0
  ; X64-NEXT:   [[COPY1:%[0-9]+]]:_(<4 x i32>) = COPY $xmm1
  ; X64-NEXT:   $xmm0 = COPY [[COPY1]](<4 x i32>)
  ; X64-NEXT:   RET 0, implicit $xmm0
  ret <4 x i32> %arg2
}
...
define <8 x i32> @test_v8i32_args(<8 x i32> %arg1) {
  ...
  ; X86-NEXT:   [[COPY:%[0-9]+]]:_(<4 x i32>) = COPY $xmm0
  ; X86-NEXT:   [[COPY1:%[0-9]+]]:_(<4 x i32>) = COPY $xmm1
  ; X86-NEXT:   [[CONCAT_VECTORS:%[0-9]+]]:_(<8 x i32>) = G_CONCAT_VECTORS [[COPY]](<4 x i32>), [[COPY1]](<4 x i32>)
  ; X86-NEXT:   [[UV:%[0-9]+]]:_(<4 x i32>), [[UV1:%[0-9]+]]:_(<4 x i32>) = G_UNMERGE_VALUES [[CONCAT_VECTORS]](<8 x i32>)
  ; X86-NEXT:   $xmm0 = COPY [[UV]](<4 x i32>)
  ; X86-NEXT:   $xmm1 = COPY [[UV1]](<4 x i32>)
  ...
  ; X64-NEXT:   [[COPY:%[0-9]+]]:_(<4 x i32>) = COPY $xmm0
  ; X64-NEXT:   [[COPY1:%[0-9]+]]:_(<4 x i32>) = COPY $xmm1
  ; X64-NEXT:   [[CONCAT_VECTORS:%[0-9]+]]:_(<8 x i32>) = G_CONCAT_VECTORS [[COPY]](<4 x i32>), [[COPY1]](<4 x i32>)
  ; X64-NEXT:   [[UV:%[0-9]+]]:_(<4 x i32>), [[UV1:%[0-9]+]]:_(<4 x i32>) = G_UNMERGE_VALUES [[CONCAT_VECTORS]](<8 x i32>)
  ; X64-NEXT:   $xmm0 = COPY [[UV]](<4 x i32>)
  ; X64-NEXT:   $xmm1 = COPY [[UV1]](<4 x i32>)
...
define void @test_simple_arg(i32 %in0, i32 %in1) {
  ...
  ; X86: bb.1 (%ir-block.0):
  ; X86-NEXT:   [[FRAME_INDEX:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.1
  ; X86-NEXT:   [[LOAD:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX]](p0) :: (invariant load (i32) from %fixed-stack.1, align 16)
  ; X86-NEXT:   [[FRAME_INDEX1:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.0
  ; X86-NEXT:   [[LOAD1:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX1]](p0) :: (invariant load (i32) from %fixed-stack.0)
  ...
  ; X86-NEXT:   G_STORE [[LOAD1]](i32), [[PTR_ADD]](p0) :: (store (i32) into stack, align 1)
  ; X86-NEXT:   [[COPY1:%[0-9]+]]:_(p0) = COPY $esp
  ; X86-NEXT:   [[C1:%[0-9]+]]:_(s32) = G_CONSTANT i32 4
  ; X86-NEXT:   [[PTR_ADD1:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY1]], [[C1]](s32)
  ; X86-NEXT:   G_STORE [[LOAD]](i32), [[PTR_ADD1]](p0) :: (store (i32) into stack + 4, align 1)
  ...
  ; X64-NEXT:   [[COPY1:%[0-9]+]]:_(i32) = COPY $esi
  ; X64-NEXT:   ADJCALLSTACKDOWN64 0, 0, 0, implicit-def $rsp, implicit-def $eflags, implicit-def $ssp, implicit $rsp, implicit $ssp
  ; X64-NEXT:   $edi = COPY [[COPY1]](i32)
  ; X64-NEXT:   $esi = COPY [[COPY]](i32)
...
define void @test_simple_arg8_call(i32 %in0) {
  ...
  ; X86: bb.1 (%ir-block.0):
  ; X86-NEXT:   [[FRAME_INDEX:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.0
  ; X86-NEXT:   [[LOAD:%[0-9]+]]:_(i32) = G_LOAD [[FRAME_INDEX]](p0) :: (invariant load (i32) from %fixed-stack.0, align 16)
  ; X86-NEXT:   ADJCALLSTACKDOWN32 32, 0, 0, implicit-def $esp, implicit-def $eflags, implicit-def $ssp, implicit $esp, implicit $ssp
  ; X86-NEXT:   [[COPY:%[0-9]+]]:_(p0) = COPY $esp
  ; X86-NEXT:   [[C:%[0-9]+]]:_(s32) = G_CONSTANT i32 0
  ; X86-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY]], [[C]](s32)
  ; X86-NEXT:   G_STORE [[LOAD]](i32), [[PTR_ADD]](p0) :: (store (i32) into stack, align 1)
  ; X86-NEXT:   [[COPY1:%[0-9]+]]:_(p0) = COPY $esp
  ; X86-NEXT:   [[C1:%[0-9]+]]:_(s32) = G_CONSTANT i32 4
  ; X86-NEXT:   [[PTR_ADD1:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY1]], [[C1]](s32)
  ; X86-NEXT:   G_STORE [[LOAD]](i32), [[PTR_ADD1]](p0) :: (store (i32) into stack + 4, align 1)
  ...
  ; X64-NEXT:   G_STORE [[COPY]](i32), [[PTR_ADD]](p0) :: (store (i32) into stack, align 1)
  ; X64-NEXT:   [[COPY2:%[0-9]+]]:_(p0) = COPY $rsp
  ; X64-NEXT:   [[C1:%[0-9]+]]:_(s64) = G_CONSTANT i64 8
  ; X64-NEXT:   [[PTR_ADD1:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY2]], [[C1]](s64)
  ; X64-NEXT:   G_STORE [[COPY]](i32), [[PTR_ADD1]](p0) :: (store (i32) into stack + 8, align 1)
  ; X64-NEXT:   $edi = COPY [[COPY]](i32)
  ; X64-NEXT:   $esi = COPY [[COPY]](i32)
  ; X64-NEXT:   $edx = COPY [[COPY]](i32)
  ; X64-NEXT:   $ecx = COPY [[COPY]](i32)
  ; X64-NEXT:   $r8d = COPY [[COPY]](i32)
  ; X64-NEXT:   $r9d = COPY [[COPY]](i32)
...
define i32 @test_simple_return_callee() {
  ...
  ; X86: bb.1 (%ir-block.0):
  ; X86-NEXT:   [[C:%[0-9]+]]:_(i32) = G_CONSTANT i32 5
...
define <8 x i32> @test_split_return_callee(<8 x i32> %arg1, <8 x i32> %arg2) {
  ...
  ; X86-NEXT:   [[COPY1:%[0-9]+]]:_(<4 x i32>) = COPY $xmm1
  ; X86-NEXT:   [[CONCAT_VECTORS:%[0-9]+]]:_(<8 x i32>) = G_CONCAT_VECTORS [[COPY]](<4 x i32>), [[COPY1]](<4 x i32>)
  ; X86-NEXT:   [[COPY2:%[0-9]+]]:_(<4 x i32>) = COPY $xmm2
  ; X86-NEXT:   [[FRAME_INDEX:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.0
  ; X86-NEXT:   [[LOAD:%[0-9]+]]:_(<4 x i32>) = G_LOAD [[FRAME_INDEX]](p0) :: (invariant load (<4 x i32>) from %fixed-stack.0)
  ; X86-NEXT:   [[CONCAT_VECTORS1:%[0-9]+]]:_(<8 x i32>) = G_CONCAT_VECTORS [[COPY2]](<4 x i32>), [[LOAD]](<4 x i32>)
  ; X86-NEXT:   ADJCALLSTACKDOWN32 0, 0, 0, implicit-def $esp, implicit-def $eflags, implicit-def $ssp, implicit $esp, implicit $ssp
  ; X86-NEXT:   [[UV:%[0-9]+]]:_(<4 x i32>), [[UV1:%[0-9]+]]:_(<4 x i32>) = G_UNMERGE_VALUES [[CONCAT_VECTORS1]](<8 x i32>)
  ; X86-NEXT:   $xmm0 = COPY [[UV]](<4 x i32>)
  ; X86-NEXT:   $xmm1 = COPY [[UV1]](<4 x i32>)
  ...
  ; X86-NEXT:   [[COPY3:%[0-9]+]]:_(<4 x i32>) = COPY $xmm0
  ; X86-NEXT:   [[COPY4:%[0-9]+]]:_(<4 x i32>) = COPY $xmm1
  ; X86-NEXT:   [[CONCAT_VECTORS2:%[0-9]+]]:_(<8 x i32>) = G_CONCAT_VECTORS [[COPY3]](<4 x i32>), [[COPY4]](<4 x i32>)
  ; X86-NEXT:   ADJCALLSTACKUP32 0, 0, implicit-def $esp, implicit-def $eflags, implicit-def $ssp, implicit $esp, implicit $ssp
  ; X86-NEXT:   [[ADD:%[0-9]+]]:_(<8 x i32>) = G_ADD [[CONCAT_VECTORS]], [[CONCAT_VECTORS2]]
  ; X86-NEXT:   [[UV2:%[0-9]+]]:_(<4 x i32>), [[UV3:%[0-9]+]]:_(<4 x i32>) = G_UNMERGE_VALUES [[ADD]](<8 x i32>)
  ; X86-NEXT:   $xmm0 = COPY [[UV2]](<4 x i32>)
  ; X86-NEXT:   $xmm1 = COPY [[UV3]](<4 x i32>)
  ; X86-NEXT:   RET 0, implicit $xmm0, implicit $xmm1
  ;
  ...
  ; X64-NEXT:   [[COPY1:%[0-9]+]]:_(<4 x i32>) = COPY $xmm1
  ; X64-NEXT:   [[CONCAT_VECTORS:%[0-9]+]]:_(<8 x i32>) = G_CONCAT_VECTORS [[COPY]](<4 x i32>), [[COPY1]](<4 x i32>)
  ; X64-NEXT:   [[COPY2:%[0-9]+]]:_(<4 x i32>) = COPY $xmm2
  ; X64-NEXT:   [[COPY3:%[0-9]+]]:_(<4 x i32>) = COPY $xmm3
  ; X64-NEXT:   [[CONCAT_VECTORS1:%[0-9]+]]:_(<8 x i32>) = G_CONCAT_VECTORS [[COPY2]](<4 x i32>), [[COPY3]](<4 x i32>)
  ; X64-NEXT:   ADJCALLSTACKDOWN64 0, 0, 0, implicit-def $rsp, implicit-def $eflags, implicit-def $ssp, implicit $rsp, implicit $ssp
  ; X64-NEXT:   [[UV:%[0-9]+]]:_(<4 x i32>), [[UV1:%[0-9]+]]:_(<4 x i32>) = G_UNMERGE_VALUES [[CONCAT_VECTORS1]](<8 x i32>)
  ; X64-NEXT:   $xmm0 = COPY [[UV]](<4 x i32>)
  ; X64-NEXT:   $xmm1 = COPY [[UV1]](<4 x i32>)
  ...
  ; X64-NEXT:   [[COPY4:%[0-9]+]]:_(<4 x i32>) = COPY $xmm0
  ; X64-NEXT:   [[COPY5:%[0-9]+]]:_(<4 x i32>) = COPY $xmm1
  ; X64-NEXT:   [[CONCAT_VECTORS2:%[0-9]+]]:_(<8 x i32>) = G_CONCAT_VECTORS [[COPY4]](<4 x i32>), [[COPY5]](<4 x i32>)
  ; X64-NEXT:   ADJCALLSTACKUP64 0, 0, implicit-def $rsp, implicit-def $eflags, implicit-def $ssp, implicit $rsp, implicit $ssp
  ; X64-NEXT:   [[ADD:%[0-9]+]]:_(<8 x i32>) = G_ADD [[CONCAT_VECTORS]], [[CONCAT_VECTORS2]]
  ; X64-NEXT:   [[UV2:%[0-9]+]]:_(<4 x i32>), [[UV3:%[0-9]+]]:_(<4 x i32>) = G_UNMERGE_VALUES [[ADD]](<8 x i32>)
  ; X64-NEXT:   $xmm0 = COPY [[UV2]](<4 x i32>)
  ; X64-NEXT:   $xmm1 = COPY [[UV3]](<4 x i32>)
  ; X64-NEXT:   RET 0, implicit $xmm0, implicit $xmm1
...
define void @test_abi_exts_call(ptr %addr) {
  ...
  ; X86-NEXT:   [[FRAME_INDEX:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.0
  ; X86-NEXT:   [[LOAD:%[0-9]+]]:_(p0) = G_LOAD [[FRAME_INDEX]](p0) :: (invariant load (p0) from %fixed-stack.0, align 16)
  ; X86-NEXT:   [[LOAD1:%[0-9]+]]:_(i8) = G_LOAD [[LOAD]](p0) :: (load (i8) from %ir.addr)
  ; X86-NEXT:   ADJCALLSTACKDOWN32 4, 0, 0, implicit-def $esp, implicit-def $eflags, implicit-def $ssp, implicit $esp, implicit $ssp
  ; X86-NEXT:   [[COPY:%[0-9]+]]:_(p0) = COPY $esp
  ; X86-NEXT:   [[C:%[0-9]+]]:_(s32) = G_CONSTANT i32 0
  ; X86-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY]], [[C]](s32)
  ; X86-NEXT:   [[ANYEXT:%[0-9]+]]:_(i32) = G_ANYEXT [[LOAD1]](i8)
  ; X86-NEXT:   G_STORE [[ANYEXT]](i32), [[PTR_ADD]](p0) :: (store (i8) into stack)
  ; X86-NEXT:   CALLpcrel32 @take_char, csr_32, implicit $esp, implicit $ssp
  ; X86-NEXT:   ADJCALLSTACKUP32 4, 0, implicit-def $esp, implicit-def $eflags, implicit-def $ssp, implicit $esp, implicit $ssp
  ; X86-NEXT:   ADJCALLSTACKDOWN32 4, 0, 0, implicit-def $esp, implicit-def $eflags, implicit-def $ssp, implicit $esp, implicit $ssp
  ; X86-NEXT:   [[COPY1:%[0-9]+]]:_(p0) = COPY $esp
  ; X86-NEXT:   [[PTR_ADD1:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY1]], [[C]](s32)
  ; X86-NEXT:   [[SEXT:%[0-9]+]]:_(i32) = G_SEXT [[LOAD1]](i8)
  ; X86-NEXT:   G_STORE [[SEXT]](i32), [[PTR_ADD1]](p0) :: (store (i8) into stack)
  ; X86-NEXT:   CALLpcrel32 @take_char, csr_32, implicit $esp, implicit $ssp
  ; X86-NEXT:   ADJCALLSTACKUP32 4, 0, implicit-def $esp, implicit-def $eflags, implicit-def $ssp, implicit $esp, implicit $ssp
  ; X86-NEXT:   ADJCALLSTACKDOWN32 4, 0, 0, implicit-def $esp, implicit-def $eflags, implicit-def $ssp, implicit $esp, implicit $ssp
  ; X86-NEXT:   [[COPY2:%[0-9]+]]:_(p0) = COPY $esp
  ; X86-NEXT:   [[PTR_ADD2:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY2]], [[C]](s32)
  ; X86-NEXT:   [[ZEXT:%[0-9]+]]:_(i32) = G_ZEXT [[LOAD1]](i8)
  ; X86-NEXT:   G_STORE [[ZEXT]](i32), [[PTR_ADD2]](p0) :: (store (i8) into stack)
  ; X86-NEXT:   CALLpcrel32 @take_char, csr_32, implicit $esp, implicit $ssp
  ; X86-NEXT:   ADJCALLSTACKUP32 4, 0, implicit-def $esp, implicit-def $eflags, implicit-def $ssp, implicit $esp, implicit $ssp
  ; X86-NEXT:   RET 0
  ;
  ...
  ; X64-NEXT: {{  $}}
  ; X64-NEXT:   [[COPY:%[0-9]+]]:_(p0) = COPY $rdi
  ; X64-NEXT:   [[LOAD:%[0-9]+]]:_(i8) = G_LOAD [[COPY]](p0) :: (load (i8) from %ir.addr)
  ; X64-NEXT:   ADJCALLSTACKDOWN64 0, 0, 0, implicit-def $rsp, implicit-def $eflags, implicit-def $ssp, implicit $rsp, implicit $ssp
  ; X64-NEXT:   [[ANYEXT:%[0-9]+]]:_(i32) = G_ANYEXT [[LOAD]](i8)
  ; X64-NEXT:   $edi = COPY [[ANYEXT]](i32)
  ; X64-NEXT:   CALL64pcrel32 @take_char, csr_64, implicit $rsp, implicit $ssp, implicit $edi
  ; X64-NEXT:   ADJCALLSTACKUP64 0, 0, implicit-def $rsp, implicit-def $eflags, implicit-def $ssp, implicit $rsp, implicit $ssp
  ; X64-NEXT:   ADJCALLSTACKDOWN64 0, 0, 0, implicit-def $rsp, implicit-def $eflags, implicit-def $ssp, implicit $rsp, implicit $ssp
  ; X64-NEXT:   [[SEXT:%[0-9]+]]:_(i32) = G_SEXT [[LOAD]](i8)
  ; X64-NEXT:   $edi = COPY [[SEXT]](i32)
  ; X64-NEXT:   CALL64pcrel32 @take_char, csr_64, implicit $rsp, implicit $ssp, implicit $edi
  ; X64-NEXT:   ADJCALLSTACKUP64 0, 0, implicit-def $rsp, implicit-def $eflags, implicit-def $ssp, implicit $rsp, implicit $ssp
  ; X64-NEXT:   ADJCALLSTACKDOWN64 0, 0, 0, implicit-def $rsp, implicit-def $eflags, implicit-def $ssp, implicit $rsp, implicit $ssp
  ; X64-NEXT:   [[ZEXT:%[0-9]+]]:_(i32) = G_ZEXT [[LOAD]](i8)
  ; X64-NEXT:   $edi = COPY [[ZEXT]](i32)
  ; X64-NEXT:   CALL64pcrel32 @take_char, csr_64, implicit $rsp, implicit $ssp, implicit $edi
  ; X64-NEXT:   ADJCALLSTACKUP64 0, 0, implicit-def $rsp, implicit-def $eflags, implicit-def $ssp, implicit $rsp, implicit $ssp
  ; X64-NEXT:   RET 0
...
define void @test_variadic_call_1(ptr %addr_ptr, ptr %val_ptr) {
  ...
  ; X86-NEXT:   [[LOAD3:%[0-9]+]]:_(i32) = G_LOAD [[LOAD1]](p0) :: (load (i32) from %ir.val_ptr)
  ; X86-NEXT:   ADJCALLSTACKDOWN32 8, 0, 0, implicit-def $esp, implicit-def $eflags, implicit-def $ssp, implicit $esp, implicit $ssp
  ; X86-NEXT:   [[COPY:%[0-9]+]]:_(p0) = COPY $esp
  ; X86-NEXT:   [[C:%[0-9]+]]:_(s32) = G_CONSTANT i32 0
  ; X86-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY]], [[C]](s32)
  ...
  ; X86-NEXT:   [[C1:%[0-9]+]]:_(s32) = G_CONSTANT i32 4
  ; X86-NEXT:   [[PTR_ADD1:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY1]], [[C1]](s32)
  ; X86-NEXT:   G_STORE [[LOAD3]](i32), [[PTR_ADD1]](p0) :: (store (i32) into stack + 4, align 1)
  ...
  ; X64-NEXT:   [[LOAD1:%[0-9]+]]:_(i32) = G_LOAD [[COPY1]](p0) :: (load (i32) from %ir.val_ptr)
  ; X64-NEXT:   ADJCALLSTACKDOWN64 0, 0, 0, implicit-def $rsp, implicit-def $eflags, implicit-def $ssp, implicit $rsp, implicit $ssp
  ; X64-NEXT:   $rdi = COPY [[LOAD]](p0)
  ; X64-NEXT:   $esi = COPY [[LOAD1]](i32)
...
define void @test_variadic_call_2(ptr %addr_ptr, ptr %val_ptr) {
  ...
  ; X86-NEXT:   [[LOAD1:%[0-9]+]]:_(p0) = G_LOAD [[FRAME_INDEX1]](p0) :: (invariant load (p0) from %fixed-stack.0)
  ; X86-NEXT:   [[LOAD2:%[0-9]+]]:_(p0) = G_LOAD [[LOAD]](p0) :: (load (p0) from %ir.addr_ptr)
  ; X86-NEXT:   [[LOAD3:%[0-9]+]]:_(f64) = G_LOAD [[LOAD1]](p0) :: (load (f64) from %ir.val_ptr, align 4)
  ...
  ; X86-NEXT:   [[C1:%[0-9]+]]:_(s32) = G_CONSTANT i32 4
  ; X86-NEXT:   [[PTR_ADD1:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY1]], [[C1]](s32)
  ; X86-NEXT:   G_STORE [[LOAD3]](f64), [[PTR_ADD1]](p0) :: (store (f64) into stack + 4, align 1)
  ; X86-NEXT:   CALLpcrel32 @variadic_callee, csr_32, implicit $esp, implicit $ssp
  ...
  ; X64-NEXT:   [[COPY1:%[0-9]+]]:_(p0) = COPY $rsi
  ; X64-NEXT:   [[LOAD:%[0-9]+]]:_(p0) = G_LOAD [[COPY]](p0) :: (load (p0) from %ir.addr_ptr)
  ; X64-NEXT:   [[LOAD1:%[0-9]+]]:_(f64) = G_LOAD [[COPY1]](p0) :: (load (f64) from %ir.val_ptr)
  ; X64-NEXT:   ADJCALLSTACKDOWN64 0, 0, 0, implicit-def $rsp, implicit-def $eflags, implicit-def $ssp, implicit $rsp, implicit $ssp
  ; X64-NEXT:   $rdi = COPY [[LOAD]](p0)
  ; X64-NEXT:   $xmm0 = COPY [[LOAD1]](f64)
...
define <32 x float> @test_return_v32f32() {
  ...
  ; X86: bb.1 (%ir-block.0):
  ; X86-NEXT:   [[FRAME_INDEX:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.0
  ; X86-NEXT:   [[LOAD:%[0-9]+]]:_(p0) = G_LOAD [[FRAME_INDEX]](p0) :: (invariant load (i32) from %fixed-stack.0, align 16)
  ; X86-NEXT:   [[C:%[0-9]+]]:_(f32) = G_FCONSTANT float 0.000000e+00
  ; X86-NEXT:   [[BUILD_VECTOR:%[0-9]+]]:_(<32 x f32>) = G_BUILD_VECTOR [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32)
  ; X86-NEXT:   G_STORE [[BUILD_VECTOR]](<32 x f32>), [[LOAD]](p0) :: (store (<32 x f32>))
  ; X86-NEXT:   $eax = COPY [[LOAD]](p0)
  ; X86-NEXT:   RET 0, $eax
  ;
  ...
  ; X64-NEXT: {{  $}}
  ; X64-NEXT:   [[COPY:%[0-9]+]]:_(p0) = COPY $rdi
  ; X64-NEXT:   [[C:%[0-9]+]]:_(f32) = G_FCONSTANT float 0.000000e+00
  ; X64-NEXT:   [[BUILD_VECTOR:%[0-9]+]]:_(<32 x f32>) = G_BUILD_VECTOR [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32), [[C]](f32)
  ; X64-NEXT:   G_STORE [[BUILD_VECTOR]](<32 x f32>), [[COPY]](p0) :: (store (<32 x f32>))
  ; X64-NEXT:   $rax = COPY [[COPY]](p0)
  ; X64-NEXT:   RET 0, $rax
...
define float @test_call_v32f32() {
  ...
  ; X86: bb.1 (%ir-block.0):
  ; X86-NEXT:   [[C:%[0-9]+]]:_(i32) = G_CONSTANT i32 7
  ...
  ; X86-NEXT:   ADJCALLSTACKUP32 4, 0, implicit-def $esp, implicit-def $eflags, implicit-def $ssp, implicit $esp, implicit $ssp
  ; X86-NEXT:   [[LOAD:%[0-9]+]]:_(<32 x f32>) = G_LOAD [[FRAME_INDEX]](p0) :: (load (<32 x f32>) from %stack.0)
  ; X86-NEXT:   [[EVEC:%[0-9]+]]:_(f32) = G_EXTRACT_VECTOR_ELT [[LOAD]](<32 x f32>), [[C]](i32)
  ; X86-NEXT:   [[FPEXT:%[0-9]+]]:_(s80) = G_FPEXT [[EVEC]](f32)
  ; X86-NEXT:   $fp0 = COPY [[FPEXT]](s80)
  ; X86-NEXT:   RET 0, implicit $fp0
  ;
  ; X64-LABEL: name: test_call_v32f32
  ; X64: bb.1 (%ir-block.0):
  ; X64-NEXT:   [[C:%[0-9]+]]:_(i64) = G_CONSTANT i64 7
  ...
  ; X64-NEXT:   ADJCALLSTACKUP64 0, 0, implicit-def $rsp, implicit-def $eflags, implicit-def $ssp, implicit $rsp, implicit $ssp
  ; X64-NEXT:   [[LOAD:%[0-9]+]]:_(<32 x f32>) = G_LOAD [[FRAME_INDEX]](p0) :: (load (<32 x f32>) from %stack.0)
  ; X64-NEXT:   [[EVEC:%[0-9]+]]:_(f32) = G_EXTRACT_VECTOR_ELT [[LOAD]](<32 x f32>), [[C]](i64)
  ; X64-NEXT:   $xmm0 = COPY [[EVEC]](f32)
  ; X64-NEXT:   RET 0, implicit $xmm0
...
define void @test_sret(ptr sret(%struct.all) align 8 %result) #0 {
  ...
  ; X86-NEXT:   [[FRAME_INDEX:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.0
  ; X86-NEXT:   [[LOAD:%[0-9]+]]:_(p0) = G_LOAD [[FRAME_INDEX]](p0) :: (invariant load (p0) from %fixed-stack.0, align 16)
  ; X86-NEXT:   [[C:%[0-9]+]]:_(i8) = G_CONSTANT i8 104
  ; X86-NEXT:   G_STORE [[C]](i8), [[LOAD]](p0) :: (store (i8) into %ir.c, align 8)
  ; X86-NEXT:   $eax = COPY [[LOAD]](p0)
  ; X86-NEXT:   RET 0, $eax
  ;
  ...
  ; X64-NEXT: {{  $}}
  ; X64-NEXT:   [[COPY:%[0-9]+]]:_(p0) = COPY $rdi
  ; X64-NEXT:   [[C:%[0-9]+]]:_(i8) = G_CONSTANT i8 104
  ; X64-NEXT:   G_STORE [[C]](i8), [[COPY]](p0) :: (store (i8) into %ir.c, align 8)
  ; X64-NEXT:   $rax = COPY [[COPY]](p0)
  ; X64-NEXT:   RET 0, $rax
entry:
